...
backends — OpenAI **gpt-image-2** / **gpt-image-1.5** and Google **gemini-3-pro-image**
("Nano Banana Pro"). Model IDs and params verified against 2026 docs.
...
# -> {"ok": true, "provider": "gemini", "model": "gemini-3-pro-image", "images": ["outputs/..._0.webp"], ...}
...
- **Two engines, one signature** — `--provider auto|openai|gemini`; `auto` routes by intent.
